...
class GoldMembershipDecoratorTest {
    @BeforeAll
    ...
    public void when_checkingIsValidForInterval_With_badInterval_Expect_toReturnFalse() {
        ...
        Membership membership = new GoldMembershipDecorator(new EmptyMembership(LocalDate.now(), LocalDate.now().plusDays(1)));

        Assertions.assertFalse(membership.isValidForInterval(start.plusDays(10), start.plusDays(20)));
