...
class AttractionTest {
    ...
    public void When_CreatingNewAttraction_With_InvalidDates_Expect_IllegalArgumentException() {
        ...
        Assertions.assertThrows(
            ...
            () -> new Attraction(0, "Drones", 10, 1, LocalDateTime.now(), LocalDateTime.now().minusMinutes(1), employeeMock.getFiscalCode(),"Drones","ok"),
        ...
        Assertions.assertThrows(
            IllegalArgumentException.class,
            () -> new Attraction(0, "Euphoria", 10, 20, d, d, employeeMock.getFiscalCode(),"Euphoria","ok"),
            "Expected constructor to throw, but it didn't"
        );
    }
}